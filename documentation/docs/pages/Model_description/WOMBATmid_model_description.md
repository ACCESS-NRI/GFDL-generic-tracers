...
- $K_{mp}^{Si}$ are the half-saturation coefficients for nitrogen uptake by nano- and micro-phytoplankton (`dia_ksi(i,j,k)`, [mmol Si m<sup>-3</sup>]) <br>
...
$Y = \% N_{2}O produced per NO_{3} produced$ <br>
...
\dfrac{\Delta NO_3}{\Delta t} = &\mu_{aoa}^{&rarr; NO_3} \\
                             ...
                             &\qquad  + \mu_{mp}^{&larr; C} \dfrac{L_{mp}^{NO_3}}{L_{mp}^{N}} \right) \cdot \dfrac{16}{122}
\end{align}
